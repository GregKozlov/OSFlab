...
export const ProductGrid = () => import('../index');

describe('ProductGrid renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {ProductGrid};
  beforeAll(async () => {
    /**
  ...
  it('ProductGrid works as expected', async done => {
    /**
