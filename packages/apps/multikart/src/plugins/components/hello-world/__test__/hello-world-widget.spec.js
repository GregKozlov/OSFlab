...
export const HelloWorld = () => import('../index');

describe('HelloWorld renders correctly and shows after changing visible state', () => {
  /**
  ...
  it('HelloWorld works as expected', async done => {
    /**
