...
export const ProductPagination = () => import('../index');

describe('ProductPagination renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {ProductPagination};
  beforeAll(async () => {
    /**
  ...
  it('ProductPagination works as expected', async done => {
    /**
