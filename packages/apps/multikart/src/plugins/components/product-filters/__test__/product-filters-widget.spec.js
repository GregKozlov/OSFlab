...
export const ProductFilters = () => import('../index');

describe('ProductFilters renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {ProductFilters};
  beforeAll(async () => {
    /**
  ...
  it('ProductFilters works as expected', async done => {
    /**
