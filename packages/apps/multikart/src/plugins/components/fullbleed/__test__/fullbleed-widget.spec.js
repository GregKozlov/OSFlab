...
export const Fullbleed = () => import('../index');

describe('fullbleed renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {Fullbleed};
  beforeAll(async () => {
    /**
  ...
  it('Fullbleed works as expected', async done => {
    /**
