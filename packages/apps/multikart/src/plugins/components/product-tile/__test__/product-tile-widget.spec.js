...
export const ProductTile = () => import('../index');

describe('ProductTile renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {ProductTile};
  beforeAll(async () => {
    /**
  ...
  it('ProductTile works as expected', async done => {
    /**
