...
export const ProductSorting = () => import('../index');

describe('ProductSorting renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {ProductSorting};
  beforeAll(async () => {
    /**
  ...
  it('ProductSorting works as expected', async done => {
    /**
