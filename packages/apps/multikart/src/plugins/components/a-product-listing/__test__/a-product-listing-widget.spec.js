...
export const AProductListing = () => import('../index');

describe('AProductListing renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {AProductListing};
  beforeAll(async () => {
    /**
  ...
  it('AProductListing works as expected', async done => {
    /**
